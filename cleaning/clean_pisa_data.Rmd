...
```{r eval=TRUE, echo=TRUE}
ind <- which(levels(pisadata_clean$Country)=="Korea, Rep.", arr.in=TRUE)
levels(pisadata_clean$Country)[ind] <- "Republic of Korea"

ind <- which(levels(pisadata_clean$Country)=="Macedonia, FYR", arr.in=TRUE)
levels(pisadata_clean$Country)[ind] <- "Macedonia"

ind <- which(levels(pisadata_clean$Country)=="Slovak Republic", arr.in=TRUE)
levels(pisadata_clean$Country)[ind] <- "Slovakia"
